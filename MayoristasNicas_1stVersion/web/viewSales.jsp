                ...
                <div id="leftside" class="grid_3">
                    ...
                    <%
                        ...
                        if(session.getAttribute("cat") != null ){
                            subcategory = (String) session.getAttribute("cat");
                            ArrayList subCat = product.getSubcategory(subcategory);
...
GROUP BY  `product-name` */
                                ...
                                sql.append(" WHERE  `sub-category-name` =  '"+subcategory+"' ");
                                %>
                                    <div class="grid_4 ">
                                        <a id="greenBtn" href="removeProductFilter.jsp?cat=<%= subcategory %>">Proveedor : <%= subcategory %> [x]</a>
                                    </div>
                                <%
                                ...
                                %>
                                    ...
                                    <%
                                        if (session.getAttribute("scat") != null){
                                            ...
                                            %>
                                                <div class="grid_4 ">
                                                    <a id="greenBtn" href="removeProductFilter.jsp?scat=<%= subcategory %>">Categoría : <%= subcategory %> [x]</a>
                                                </div>
                                            <%
                                        }
                                    %>
