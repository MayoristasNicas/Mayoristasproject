                    ...
                    <%
                        ...
                        if(session.getAttribute("cat") != null ){
                            ...
                            for (int i =0; i< subCat.size(); i++){
                                %>
                                <li><a href="addProductFilters_P.jsp?scat=<%= subCat.get(i) %>"><%= subCat.get(i) %></a></li>      
                                <%
                            } subCat.clear(); %>
                                </ul>
                            </div>
                            ...
                            for (int i =0; i< Cat.size(); i++){
                                %>
                                <li><a href="addProductFilters_P.jsp?cat=<%= Cat.get(i) %>"><%= Cat.get(i) %></a></li>      
                                <%
                            } Cat.clear();
                            %>
                                </ul>
                        ...
                        ResultSet rs ;
                         ...
                         if (sql.toString().equalsIgnoreCase("SELECT * FROM  `products` p "
                            ...
                            String newSQL  = "SELECT * FROM  `products` p "
                                            + "INNER JOIN  `images` i "
                                           + "USING (  `product-name` ) "
                                            + " WHERE `product_qty` > 0 AND `sub-category-name` = 'Promocion'"
                                          +" GROUP BY  `product-name` "
                                         + " ORDER BY  `hits` DESC  ";
